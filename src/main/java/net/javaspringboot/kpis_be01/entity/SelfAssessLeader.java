...
@Setter
@Entity
@Table(name = "self_assess_leader")
public class SelfAssessLeader {
    @Id
    ...
    @Column
    private int chat_luong_ho_tro_giai_quyet_van_de;
    @Column
    ...
    @Column
    @NotBlank
    private String room_symbol;//dùng để liên kết dữ liệu
    @Column
